...
- **プロファイル情報**。プロファイル情報を削除するには、ユーザーが **[自分]** \> **[プロファイルの更新]** を選択して、自由形式のテキストを削除します。グローバル アドレス一覧での組織の設定によっては、ユーザーは自分の名前や役職などの一部のプロファイル情報を削除できないことがあります。
