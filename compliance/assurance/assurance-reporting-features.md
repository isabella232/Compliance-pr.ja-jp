...
| [メールボックスのコンテンツの検索と保持](https://docs.microsoft.com/exchange/security-and-compliance/in-place-ediscovery/in-place-ediscovery) | メールボックスの電子情報開示または In-Place 保持設定を In-Place する際の変更点について詳細に説明します。 |
