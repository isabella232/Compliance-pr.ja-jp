...
## <a name="soft-deleted-and-hard-deleted-mailboxes"></a>Soft-Deleted と Hard-Deleted メールボックス

回復可能な削除によって削除されたユーザーメールボックスは、Microsoft 365 管理センターまたは Remove-Mailbox コマンドレットを使用して削除されたメールボックスであり、まだ Azure Active Directory のごみ箱に30日間しかありません。 メールボックスは、次のいずれかの方法で回復可能な削除になることがあります。
...
## <a name="soft-deleted-and-hard-deleted-items"></a>Soft-Deleted と Hard-Deleted のアイテム
